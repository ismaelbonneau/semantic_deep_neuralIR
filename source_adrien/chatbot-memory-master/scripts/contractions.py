...
if __name__ == "__main__":  
  # examples
  print(expand_contractions('Don\'t you get it?'))
  ...
  print(expand_contractions('You\'ve got serious cojones coming in here like that.'))
  print(expand_contractions('I hadn\'t\'ve enough'))
